...
REGION=us-east-1
BUCKET=tcfs
PREFIX=neo-mounted-reverse-read-20260510T035624Z
TCFS_BIN=/tmp/tcfs-fleet-pilot-build-20260509T1907Z/target/debug/tcfs
HONEY_ROOT_RAW='/tmp/tcfs-mounted-reverse-read-20260510T035625Z-44117-honey/root'
RUN_DIR=/tmp/tcfs-mounted-reverse-read-20260510T035625Z-44117-honey/run
FIXTURE_FILE=Projects/shared/mounted-reverse-notes.md
INITIAL_CONTENT="${TCFS_HONEY_INITIAL_CONTENT_FILE:-/tmp/tcfs-mounted-reverse-read-20260510T035625Z-44117-honey/run/honey-initial-content.txt}"
MUTATED_CONTENT="${TCFS_HONEY_MUTATED_CONTENT_FILE:-/tmp/tcfs-mounted-reverse-read-20260510T035625Z-44117-honey/run/honey-mutated-content.txt}"
