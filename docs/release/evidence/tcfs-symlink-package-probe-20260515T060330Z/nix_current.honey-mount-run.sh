...
REMOTE=seaweedfs://100.64.48.53:8333/tcfs/tcfs-symlink-nix-consumer-probe-20260515T060330Z-nix_current
TCFS_BIN=/nix/store/yw9k9r34ma131ab3casy2h9129ds8qgb-tcfs-cli-0.12.12/bin/tcfs
MOUNT_ROOT=/tmp/tcfs-symlink-nix-consumer-probe-20260515T060330Z/mount-nix_current
SMOKE_SCRIPT=/tmp/tcfs-symlink-nix-consumer-probe-20260515T060330Z/lazy-hydration-mounted-smoke.sh
EXPECTED_CONTENT_FILE=/tmp/tcfs-symlink-nix-consumer-probe-20260515T060330Z/target.txt.expected
SYMLINK_TARGETS_FILE=/tmp/tcfs-symlink-nix-consumer-probe-20260515T060330Z/symlink-targets.tsv
MOUNT_LOG=/tmp/tcfs-symlink-nix-consumer-probe-20260515T060330Z/nix_current.mount.log
