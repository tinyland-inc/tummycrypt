...
REMOTE=seaweedfs://100.64.48.53:8333/tcfs/git-repo-canary-oauth-mux-sourcebin-fresh-20260515T014640Z
TCFS_BIN=/tmp/tcfs-current-srcbin-a76d48db3e06/bin/tcfs
MOUNT_ROOT_RAW='/tmp/tcfs-home-canary-linux-xr-shadow-20260515T021811Z/mount'
case "$MOUNT_ROOT_RAW" in
  "~/"*) MOUNT_ROOT="${HOME}/${MOUNT_ROOT_RAW#\~/}" ;;
  *) MOUNT_ROOT="$MOUNT_ROOT_RAW" ;;
esac
SMOKE_SCRIPT="${TCFS_HONEY_SMOKE_SCRIPT:-/tmp/tcfs-home-canary-linux-xr-shadow-20260515T021811Z/lazy-hydration-mounted-smoke.sh}"
EXPECTED_CONTENT_FILE="${TCFS_HONEY_EXPECTED_CONTENT_FILE:-/tmp/tcfs-home-canary-linux-xr-shadow-20260515T021811Z/selected-hydration-file.content}"
SYMLINK_TARGETS_FILE="${TCFS_HONEY_SYMLINK_TARGETS_FILE:-/tmp/tcfs-home-canary-linux-xr-shadow-20260515T021811Z/symlink-targets.tsv}"
MOUNT_LOG="${TCFS_HONEY_MOUNT_LOG:-/tmp/tcfs-home-canary-linux-xr-shadow-20260515T021811Z/mount.log}"
SMOKE_MAX_DEPTH="${TCFS_HONEY_SMOKE_MAX_DEPTH:-8}"
SMOKE_TIMEOUT_SECS="${TCFS_HONEY_SMOKE_TIMEOUT_SECS:-900}"
EXPECTED_FILE=.claude/settings.local.json
