...
- Shadow: `/Users/jess/TCFS Pilot/real-canaries/oauth-mux-shadow-20260515T013855Z`
- Remote: `seaweedfs://100.64.48.53:8333/tcfs/git-repo-canary-oauth-mux-sourcebin-fresh-20260515T014640Z`
- Branch: `main`
- Head: `d9057221ad006f5838dcaca498de5d707b4c3280`
- Config: `/Users/jess/git/tummycrypt/docs/release/evidence/git-repo-canary-oauth-mux-sourcebin-fresh-20260515T014640Z/state/tcfs-git-repo-canary.toml`
- State JSON: `/Users/jess/git/tummycrypt/docs/release/evidence/git-repo-canary-oauth-mux-sourcebin-fresh-20260515T014640Z/state/push-state.json`
...
- `push-run-metadata.env`: push-time metadata preserved before the later
  resume/honey/lifecycle pass updated `run-metadata.env`
- `push-storage-summary.env` and `push-storage-summary.md`: storage-facing
  totals extracted from `push.log`
