...
```text
seaweedfs://100.64.48.53:8333/tcfs/git-repo-canary-linux-xr-fast-sourcefix-index-20260516T045054Z/linux-lifecycle
```

Pilot root:

```text
/Users/jess/TCFS Pilot/runs/fleet-parity-20260516T053814Z-6130
```
