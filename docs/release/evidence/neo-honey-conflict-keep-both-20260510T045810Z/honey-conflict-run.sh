...
REGION=us-east-1
BUCKET=tcfs
PREFIX=neo-honey-conflict-keep-both-20260510T045810Z
TCFS_BIN=/tmp/tcfs-fleet-pilot-build-20260509T1907Z/target/debug/tcfs
HONEY_ROOT_RAW='/tmp/tcfs-neo-honey-conflict-20260510T045814Z-47369-honey/root'
RUN_DIR=/tmp/tcfs-neo-honey-conflict-20260510T045814Z-47369-honey/run
FIXTURE_FILE=Projects/shared/conflict-notes.md
CONFLICT_COPY_FILE=Projects/shared/conflict-notes.conflict-honey.md
BASE_CONTENT="${TCFS_HONEY_BASE_CONTENT_FILE:-/tmp/tcfs-neo-honey-conflict-20260510T045814Z-47369-honey/run/base-content.txt}"
NEO_CONTENT="${TCFS_HONEY_NEO_CONTENT_FILE:-/tmp/tcfs-neo-honey-conflict-20260510T045814Z-47369-honey/run/neo-conflict-content.txt}"
HONEY_CONTENT="${TCFS_HONEY_CONFLICT_CONTENT_FILE:-/tmp/tcfs-neo-honey-conflict-20260510T045814Z-47369-honey/run/honey-conflict-content.txt}"
