...
REMOTE=seaweedfs://100.64.48.53:8333/tcfs/neo-honey-reverse-unsynced-rehydrate-20260510T022657Z
ENDPOINT=http://100.64.48.53:8333
REGION=us-east-1
BUCKET=tcfs
PREFIX=neo-honey-reverse-unsynced-rehydrate-20260510T022657Z
TCFS_BIN=/tmp/tcfs-fleet-pilot-build-20260509T1907Z/target/debug/tcfs
HONEY_ROOT_RAW='/tmp/tcfs-neo-honey-reverse-unsynced-rehydrate-20260510T022657Z-honey/root'
RUN_DIR=/tmp/tcfs-neo-honey-reverse-unsynced-rehydrate-20260510T022657Z-honey/run
FIXTURE_FILE=Projects/shared/reverse-notes.md
INITIAL_CONTENT="${TCFS_HONEY_INITIAL_CONTENT_FILE:-/tmp/tcfs-neo-honey-reverse-unsynced-rehydrate-20260510T022657Z-honey/run/neo-initial-content.txt}"
MUTATED_CONTENT="${TCFS_HONEY_MUTATED_CONTENT_FILE:-/tmp/tcfs-neo-honey-reverse-unsynced-rehydrate-20260510T022657Z-honey/run/neo-mutated-content.txt}"
