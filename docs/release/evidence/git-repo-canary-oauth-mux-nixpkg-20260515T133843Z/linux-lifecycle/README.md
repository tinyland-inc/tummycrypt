...
```text
seaweedfs://100.64.48.53:8333/tcfs/git-repo-canary-oauth-mux-nixpkg-20260515T133843Z/linux-lifecycle
```

Pilot root:

```text
/Users/jess/TCFS Pilot/runs/fleet-parity-20260515T134840Z-71742
```
