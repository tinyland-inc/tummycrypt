...
MOUNT_ROOT_RAW='/tmp/tcfs-home-canary-linux-xr-shadow-20260515T133844Z/mount'
case "$MOUNT_ROOT_RAW" in
  "~/"*) MOUNT_ROOT="${HOME}/${MOUNT_ROOT_RAW#\~/}" ;;
  *) MOUNT_ROOT="$MOUNT_ROOT_RAW" ;;
esac
SMOKE_SCRIPT="${TCFS_HONEY_SMOKE_SCRIPT:-/tmp/tcfs-home-canary-linux-xr-shadow-20260515T133844Z/lazy-hydration-mounted-smoke.sh}"
EXPECTED_CONTENT_FILE="${TCFS_HONEY_EXPECTED_CONTENT_FILE:-/tmp/tcfs-home-canary-linux-xr-shadow-20260515T133844Z/selected-hydration-file.content}"
SYMLINK_TARGETS_FILE="${TCFS_HONEY_SYMLINK_TARGETS_FILE:-/tmp/tcfs-home-canary-linux-xr-shadow-20260515T133844Z/symlink-targets.tsv}"
MOUNT_LOG="${TCFS_HONEY_MOUNT_LOG:-/tmp/tcfs-home-canary-linux-xr-shadow-20260515T133844Z/mount.log}"
