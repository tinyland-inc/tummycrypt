...
REGION=us-east-1
BUCKET=tcfs
PREFIX=neo-honey-conflict-daemon-keep-both-20260510T054611Z
...
HONEY_ROOT_RAW='/tmp/tcfs-neo-honey-conflict-20260510T054622Z-94850-honey/root'
RUN_DIR=/tmp/tcfs-neo-honey-conflict-20260510T054622Z-94850-honey/run
...
BASE_CONTENT="${TCFS_HONEY_BASE_CONTENT_FILE:-/tmp/tcfs-neo-honey-conflict-20260510T054622Z-94850-honey/run/base-content.txt}"
NEO_CONTENT="${TCFS_HONEY_NEO_CONTENT_FILE:-/tmp/tcfs-neo-honey-conflict-20260510T054622Z-94850-honey/run/neo-conflict-content.txt}"
HONEY_CONTENT="${TCFS_HONEY_CONFLICT_CONTENT_FILE:-/tmp/tcfs-neo-honey-conflict-20260510T054622Z-94850-honey/run/honey-conflict-content.txt}"
SIBLING_BASE_CONTENT="${TCFS_HONEY_SIBLING_BASE_CONTENT_FILE:-/tmp/tcfs-neo-honey-conflict-20260510T054622Z-94850-honey/run/sibling-base-content.txt}"
HONEY_SIBLING_CONTENT="${TCFS_HONEY_SIBLING_CONTENT_FILE:-/tmp/tcfs-neo-honey-conflict-20260510T054622Z-94850-honey/run/honey-sibling-content.txt}"
