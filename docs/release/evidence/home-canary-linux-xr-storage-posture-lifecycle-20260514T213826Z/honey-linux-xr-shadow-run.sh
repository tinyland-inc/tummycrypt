...
MOUNT_ROOT_RAW='/tmp/tcfs-storage-posture-lifecycle-20260514T213826Z/mount'
case "$MOUNT_ROOT_RAW" in
  "~/"*) MOUNT_ROOT="${HOME}/${MOUNT_ROOT_RAW#\~/}" ;;
  *) MOUNT_ROOT="$MOUNT_ROOT_RAW" ;;
esac
SMOKE_SCRIPT="${TCFS_HONEY_SMOKE_SCRIPT:-/tmp/tcfs-storage-posture-lifecycle-20260514T213826Z/lazy-hydration-mounted-smoke.sh}"
EXPECTED_CONTENT_FILE="${TCFS_HONEY_EXPECTED_CONTENT_FILE:-/tmp/tcfs-storage-posture-lifecycle-20260514T213826Z/selected-hydration-file.content}"
SYMLINK_TARGETS_FILE="${TCFS_HONEY_SYMLINK_TARGETS_FILE:-/tmp/tcfs-storage-posture-lifecycle-20260514T213826Z/symlink-targets.tsv}"
MOUNT_LOG="${TCFS_HONEY_MOUNT_LOG:-/tmp/tcfs-storage-posture-lifecycle-20260514T213826Z/mount.log}"
