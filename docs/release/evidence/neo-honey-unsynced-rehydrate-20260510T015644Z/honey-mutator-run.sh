...
REMOTE=seaweedfs://100.64.48.53:8333/tcfs/neo-honey-unsynced-rehydrate-20260510T015644Z
TCFS_BIN=/tmp/tcfs-fleet-pilot-build-20260509T1907Z/target/debug/tcfs
MOUNT_ROOT_RAW='/tmp/tcfs-neo-honey-unsynced-rehydrate-20260510T015644Z-honey/mount'
case "$MOUNT_ROOT_RAW" in
  "~/"*) MOUNT_ROOT="${HOME}/${MOUNT_ROOT_RAW#\~/}" ;;
  *) MOUNT_ROOT="$MOUNT_ROOT_RAW" ;;
esac
FIXTURE_FILE=Projects/shared/notes.md
EXPECTED_INITIAL="${TCFS_HONEY_INITIAL_CONTENT_FILE:-/tmp/tcfs-neo-honey-unsynced-rehydrate-20260510T015644Z-honey/run/neo-initial-content.txt}"
EXPECTED_MUTATED="${TCFS_HONEY_MUTATED_CONTENT_FILE:-/tmp/tcfs-neo-honey-unsynced-rehydrate-20260510T015644Z-honey/run/honey-mutated-content.txt}"
SMOKE_SCRIPT="${TCFS_HONEY_SMOKE_SCRIPT:-/tmp/tcfs-neo-honey-unsynced-rehydrate-20260510T015644Z-honey/run/lazy-hydration-mounted-smoke.sh}"
MOUNT_LOG="${TCFS_HONEY_MOUNT_LOG:-/tmp/tcfs-neo-honey-unsynced-rehydrate-20260510T015644Z-honey/run/mount.log}"
