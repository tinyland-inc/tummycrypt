...
REGION=us-east-1
BUCKET=tcfs
PREFIX=neo-honey-delete-rename-unsynced-20260510T040456Z
TCFS_BIN=/tmp/tcfs-fleet-pilot-build-20260509T1907Z/target/debug/tcfs
HONEY_ROOT_RAW='/tmp/tcfs-delete-rename-unsynced-20260510T040456Z-56713-honey/root'
RUN_DIR=/tmp/tcfs-delete-rename-unsynced-20260510T040456Z-56713-honey/run
...
DELETE_CONTENT="${TCFS_HONEY_DELETE_CONTENT_FILE:-/tmp/tcfs-delete-rename-unsynced-20260510T040456Z-56713-honey/run/delete-initial-content.txt}"
RENAME_CONTENT="${TCFS_HONEY_RENAME_CONTENT_FILE:-/tmp/tcfs-delete-rename-unsynced-20260510T040456Z-56713-honey/run/rename-content.txt}"
