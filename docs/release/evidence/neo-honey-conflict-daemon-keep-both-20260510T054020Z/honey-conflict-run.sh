...
REGION=us-east-1
BUCKET=tcfs
PREFIX=neo-honey-conflict-daemon-keep-both-20260510T054020Z
TCFS_BIN=/tmp/tcfs-fleet-pilot-build-20260509T1907Z/target/debug/tcfs
TCFSD_BIN=tcfsd
HONEY_ROOT_RAW='/tmp/tcfs-neo-honey-conflict-20260510T054029Z-87207-honey/root'
RUN_DIR=/tmp/tcfs-neo-honey-conflict-20260510T054029Z-87207-honey/run
...
BASE_CONTENT="${TCFS_HONEY_BASE_CONTENT_FILE:-/tmp/tcfs-neo-honey-conflict-20260510T054029Z-87207-honey/run/base-content.txt}"
NEO_CONTENT="${TCFS_HONEY_NEO_CONTENT_FILE:-/tmp/tcfs-neo-honey-conflict-20260510T054029Z-87207-honey/run/neo-conflict-content.txt}"
HONEY_CONTENT="${TCFS_HONEY_CONFLICT_CONTENT_FILE:-/tmp/tcfs-neo-honey-conflict-20260510T054029Z-87207-honey/run/honey-conflict-content.txt}"
SIBLING_BASE_CONTENT="${TCFS_HONEY_SIBLING_BASE_CONTENT_FILE:-/tmp/tcfs-neo-honey-conflict-20260510T054029Z-87207-honey/run/sibling-base-content.txt}"
HONEY_SIBLING_CONTENT="${TCFS_HONEY_SIBLING_CONTENT_FILE:-/tmp/tcfs-neo-honey-conflict-20260510T054029Z-87207-honey/run/honey-sibling-content.txt}"
